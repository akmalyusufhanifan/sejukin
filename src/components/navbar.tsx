...
export default function NavBar() {
  ...
  return (
    <>
      <nav className="sticky top-0 flex justify-between items-center bg-white h-16 px-8 shadow lg:px-40">
        {/* logo */}
      ...
      <div
        ...
        className={`fixed inset-0 bg-black/5 backdrop-blur-xs z-40 md:hidden transition-opacity ${
      ...
      {/* navigation slide */}
      <div
        className={`fixed top-0 right-0 h-full w-64 md:hidden bg-white shadow-xl z-50 transform transition-transform duration-300 ${
